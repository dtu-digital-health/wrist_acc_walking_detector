...
This **Reproducible Project Template** repository is maintained by **Digital Health, DTU** to provide a standardized foundation for research projects and student work. It is based on [The Turing Way's reproducible project template](https://github.com/alan-turing-institute/reproducible-project-template) and demonstrates the practical integration of reproducibility practices in collaborative online repositories.
...
You can suggest topics to include in this repository, report mistakes/bugs, create Pull Requests to fix an error, offer resources or help develop or review the template materials.

## Contributing improvements back to The Turing Way

If you make improvements to this template that would benefit the wider community, please consider contributing them back to [The Turing Way's original template repository](https://github.com/alan-turing-institute/reproducible-project-template). This helps the entire open science community benefit from your work.
...
This template is based on [The Turing Way's reproducible project template](https://github.com/alan-turing-institute/reproducible-project-template). For a more detailed contribution guideline and best practices, please check out *[The Turing Way's CONTRIBUTING.md file](https://github.com/alan-turing-institute/the-turing-way/blob/main/CONTRIBUTING.md)*.
