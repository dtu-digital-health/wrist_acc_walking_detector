...
*This Code of Conduct is the standard for repositories within Digital Health, DTU. When using this template for your project, you may adapt specific sections to meet your project's unique needs while maintaining the core values and principles outlined here.*
...
by contacting the project maintainer or section head.

**For this template repository**, please contact:
- **Template Maintainer**: Nigel Sjolin Grech ([GitHub](https://github.com/NGrech))
- **Section Head**: Jakob Eyvind Bardram ([GitHub](https://github.com/bardram))

**When using this template for your own project**, please update this section with the appropriate contact information for your project's maintainers and leaders.

To report an issue involving both the project maintainer and section head, please contact DTU's appropriate administrative office or HR department according to DTU's policies. 
...
This Code of Conduct has been adapted for Digital Health, DTU and is based on [The Turing Way's reproducible project template](https://github.com/alan-turing-institute/reproducible-project-template). The original template drew from multiple sources including the Open Code of Conduct from the [TODO Group](https://github.com/todogroup/opencodeofconduct/), [The Carpentries Code of Conduct](https://docs.carpentries.org/topic_folders/policies/index_coc.html), [Contributor Covenant version 2.0](https://www.contributor-covenant.org/version/2/0/code_of_conduct.html), and [The Turing Way](https://the-turing-way.netlify.app/).
